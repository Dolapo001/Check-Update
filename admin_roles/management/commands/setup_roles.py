...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        role_permissions = {
            ...
            'Editor': [
                'view_content', 'change_content', 'delete_content',
            ...
            'SEO Analyst': [
                'view_seodata', 'change_seodata', 'can_manage_seo',
                'view_content'
            ],
            'Ad Manager': [
                'view_adbanner', 'add_adbanner', 'change_adbanner',
                'delete_adbanner', 'can_manage_ads'
            ],
        }
